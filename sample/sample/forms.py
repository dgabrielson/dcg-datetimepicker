...
class SampleForm(forms.Form):
    ...
    datepicker_no_script_tag = forms.DateField(
        widget=DateTimePicker(
            options={
                "format": "%Y-%m-%d",
                "timepicker": False
    ...
    timepicker_no_script_tag = forms.TimeField(
        widget=DateTimePicker(
            options={
                "format": "%H:%M",
                "datepicker": False
    ...
    datetimepicker_no_script_tag = forms.DateTimeField(
        widget=DateTimePicker(
    ...
    def media(self):
        js_urls = js_loader_url(
            fields=self.fields,
            input_ids=[
                'datepicker_no_script_tag', 'timepicker_no_script_tag',
